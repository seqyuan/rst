  ...
  return (
    <div className="border rounded-xl overflow-hidden my-4 bg-fd-card">
      <div className="relative bg-fd-muted/50 flex items-center justify-center p-4 min-h-[300px]">
        <button
          onClick={prev}
          className="absolute left-2 z-10 w-10 h-10 rounded-full bg-fd-background/80 border shadow flex items-center justify-center hover:bg-fd-background"
          aria-label="Previous"
        >
          ‹
        </button>
        ...
        <button
          onClick={next}
          className="absolute right-2 z-10 w-10 h-10 rounded-full bg-fd-background/80 border shadow flex items-center justify-center hover:bg-fd-background"
          aria-label="Next"
        >
          ›
        </button>
